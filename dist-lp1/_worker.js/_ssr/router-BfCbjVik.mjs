...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BfCbjVik.js
...
var $$splitComponentImporter = () => import("./routes-BEEhPNOt.mjs");
var Route = createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			property: "og:description",
			content: "2 dias de transformação, identidade e reconstrução familiar. 04 e 05 de Julho, das 13h às 19h. R$ 37,00."
		},
		{
			property: "og:type",
			content: "website"

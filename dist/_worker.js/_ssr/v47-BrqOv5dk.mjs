...
import { n as captureUtms, r as trackLp2, t as LeadModal } from "./LeadModal-DQoBkqN5.mjs";
import { n as SpotlightCard, r as Waves, t as BlurText } from "./Waves-YZNJI1Ym.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/v47-BrqOv5dk.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var CHECKOUT = "https://pay.assiny.com.br/A6B-P6/node/ixRfFj";
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						style: { background: "linear-gradient(180deg, rgba(12,26,15,0.18) 0%, rgba(12,26,15,0.08) 22%, rgba(12,26,15,0.55) 50%, rgba(12,26,15,0.92) 70%, #0c1a0f 100%)" }
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "absolute bottom-0 left-0 right-0 z-10 px-5 pb-8",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "badge-gold inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wider mb-3",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-1.5 h-1.5 rounded-full bg-gold animate-pulse" }), " De Frente com a Homossexualidade"]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
								className: "font-display text-[1.85rem] leading-[1.07] text-navy mb-2",
								children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Antes de tentar mudar o comportamento do seu filho, aprenda a alcançar o coração dele."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-center gap-4 mb-5 flex-nowrap",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Calendar, {
											...
											style: { color: "rgba(245,239,226,0.72)" },
											children: "13 a 16 de julho"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex items-center gap-1.5 flex-shrink-0",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
								...
								onClick: openModal,
								className: "btn-gold flex items-center justify-center gap-2 w-full rounded-full font-bold whitespace-nowrap",
								style: {
									padding: "13px 20px",
									fontSize: "0.82rem",
								...
								children: [
									CTA_PRIMARY,
									" ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-3.5 h-3.5 flex-shrink-0" })
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "text-center text-xs mt-2",
								style: { color: "rgba(245,239,226,0.42)" },
								children: [
									"Apenas ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "font-bold",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
								...
								children: [
									CTA_PRIMARY,
									" ",
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "w-4 h-4 group-hover:translate-x-1 transition-transform" })
								]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Star, { className: "w-3 h-3 text-gold fill-gold" }),
					" ",
					item
				]
			}, i))
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								style: { background: "rgba(14,28,12,0.6)" },
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: ["R$ 47", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								className: `flex-shrink-0 w-8 h-8 rounded-full border flex items-center justify-center transition-all duration-300 ${isOpen ? "rotate-45 bg-gold border-gold" : "border-gold/30"}`,
...
//#endregion
export { LandingPageV47 as component };

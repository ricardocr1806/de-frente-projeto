...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DyMcgsRk.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-CjfsAfz6.css";
...
var $$splitComponentImporter$4 = () => import("./v47-BV1F-eIC.mjs");
var Route$4 = createFileRoute("/v47")({
	head: () => ({
		meta: [
			{ title: "De Frente com a Homossexualidade — Imersão Online | Pierry Rodrigues" },
			{
				name: "description",
				content: "Imersão online e ao vivo de 2 dias sobre identidade, fé e reconstrução familiar. Para homens em conflito e para pais."
			},
			{
				property: "og:title",
			...
			{
				property: "og:description",
				content: "2 dias de transformação, identidade e reconstrução familiar."
			},
			{
				property: "og:type",
				content: "website"
...
var $$splitComponentImporter$3 = () => import("./v27-DwjBVwQW.mjs");
var Route$3 = createFileRoute("/v27")({
	head: () => ({
		meta: [
			{ title: "De Frente com a Homossexualidade — Imersão Online | Pierry Rodrigues" },
			{
...
var $$splitComponentImporter$2 = () => import("./obrigado-B3df705L.mjs");
var Route$2 = createFileRoute("/obrigado")({
...
var $$splitComponentImporter$1 = () => import("./new-B6lP0Qmb.mjs");
var Route$1 = createFileRoute("/new")({
	head: () => ({ meta: [
		{ title: "De Frente com a Homossexualidade — Imersão para Pais" },
		{
			name: "description",
			content: "Uma imersão de 4 dias para pais que querem entender, reconstruir a comunicação e se aproximar sem perder o filho."
		},
		{
			property: "og:title",
...
var $$splitComponentImporter = () => import("./routes-BuJ1bAf1.mjs");
...
var V47Route = Route$4.update({
	id: "/v47",
	path: "/v47",
	getParentRoute: () => Route$5
});
var V27Route = Route$3.update({
	id: "/v27",
	path: "/v27",
	getParentRoute: () => Route$5
});
var ObrigadoRoute = Route$2.update({
	id: "/obrigado",
	path: "/obrigado",
	getParentRoute: () => Route$5
});
var NewRoute = Route$1.update({
	id: "/new",
	path: "/new",
	getParentRoute: () => Route$5
});

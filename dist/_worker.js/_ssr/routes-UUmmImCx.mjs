...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-UUmmImCx.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						style: { background: "linear-gradient(180deg, rgba(8,17,11,0.22) 0%, rgba(8,17,11,0.10) 28%, rgba(8,17,11,0.60) 55%, rgba(8,17,11,0.94) 76%, rgba(8,17,11,0.99) 100%)" }
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "absolute bottom-0 left-0 right-0 z-10 px-5 pb-9",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-[10px] font-bold uppercase tracking-[0.22em] mb-2",
								style: { color: "rgba(224,182,79,0.6)" },
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
								className: "font-display text-[1.85rem] leading-[1.07] text-navy mb-3",
								children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								style: { color: "rgba(245,239,226,0.70)" },
								children: "Aprenda a alcançar o coração do seu filho antes de tentar mudar seu comportamento."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex flex-wrap gap-3 text-xs mb-5 font-medium",
								style: { color: "rgba(245,239,226,0.58)" },
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "📅 Dias 13 a 16 de julho" }),

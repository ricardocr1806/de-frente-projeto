...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-SOIzxlii.js
...
function Hero({ openModal }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		style: { background: "#0c1a0f" },
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute inset-0 z-0 pointer-events-none",
				style: {
					background: "radial-gradient(55% 55% at 68% 32%, rgba(245,217,148,.18) 0%, rgba(210,169,90,.08) 44%, transparent 80%)",
					mixBlendMode: "screen",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					delay: 100,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-8 text-lg max-w-3xl leading-relaxed",
						style: { color: "#6b5535" },
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "text-xl font-display italic leading-relaxed text-balance",
									style: { color: "#2a2015" },
									children: [

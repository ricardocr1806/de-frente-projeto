import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-D8mLXoMc.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-22cR0xhh.mjs");

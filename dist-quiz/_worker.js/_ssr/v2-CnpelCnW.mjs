...
//#region node_modules/.nitro/vite/services/ssr/assets/v2-CnpelCnW.js
...
var V2_THEME = {
	...
	"--popover": "#122116",
	"--popover-foreground": "#f5efe2",
	"--muted": "#1a2d1e",
	"--muted-foreground": "rgba(245,239,226,0.55)",
	"--accent": "#1a2d1e",
	...
	"--ring": "#e0b64f",
	"--primary": "#e0b64f",
	"--primary-foreground": "#0c1a0f",
	"--rainbow-red": "#c9983a",
	"--rainbow-orange": "#e0b64f",
	"--rainbow-yellow": "#efc96b",
	"--rainbow-green": "#5a9b68",
	"--rainbow-blue": "#4a8a6a",
	"--rainbow-indigo": "#c9983a",
	"--rainbow-violet": "#e0b64f",
	"--gradient-rainbow": "linear-gradient(135deg, #efc96b 0%, #e0b64f 40%, #c9983a 100%)",
	"--gradient-rainbow-no-red": "linear-gradient(135deg, #efc96b 0%, #e0b64f 40%, #c9983a 100%)",
	background: "#0c1a0f",
	color: "#f5efe2",
	minHeight: "100dvh"
};
var GOLD = "#e0b64f";
var CREAM = "#f5efe2";
var CREAM_MUTED = "rgba(245,239,226,0.62)";
var CARD_BG = "#122116";
var GOLD_GRADIENT = "linear-gradient(135deg, #efc96b 0%, #e0b64f 40%, #c9983a 100%)";
var GOLD_BORDER = "rgba(224,182,79,0.35)";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				onClick: onStart,
				className: "mt-10 inline-block w-full sm:w-auto px-10 py-4 rounded-full text-base sm:text-lg shadow-xl transition-transform hover:-translate-y-0.5",
				style: {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				style: { color: "rgba(245,239,226,0.38)" },
...
function V2InsertScreen({ insert, onContinue }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: insert.body.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						style: { color: p.bold ? CREAM : CREAM_MUTED },
						children: p.text
					}, i))
				}),
				insert.bullets && insert.bullets.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					...
					children: insert.bullets.map((b, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
						...
						style: {
							background: "rgba(224,182,79,0.12)",
							color: GOLD,
			...
			onClick: onContinue,
			className: "mt-8 w-full py-4 rounded-full font-bold text-base sm:text-lg shadow-lg transition-transform hover:-translate-y-0.5",
			style: {
				background: GOLD_GRADIENT,
				color: "#0c1a0f"
			},
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				style: {
					border: `2px solid ${GOLD_BORDER}`,
					background: "rgba(224,182,79,0.08)"
				},
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: onContinue,
					className: "w-full py-4 rounded-full font-semibold text-base sm:text-lg shadow-lg transition-transform hover:-translate-y-0.5",
					style: {
						background: GOLD_GRADIENT,
						color: "#0c1a0f",
						fontWeight: 700

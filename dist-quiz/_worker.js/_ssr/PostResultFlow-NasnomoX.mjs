import { r as __toESM } from "../__23tanstack-start-server-fn-resolver-BQKdnIQR.mjs";
import { l as createServerFn } from "./esm-Dova13aH.mjs";
import { n as stringType, t as objectType } from "../_libs/zod.mjs";
import { r as trackStep, t as createSsrRpc } from "./analytics-ObSUkP0F.mjs";
import { n as require_jsx_runtime, r as require_react } from "../_libs/react+tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/PostResultFlow-NasnomoX.js
...
function LoadingScreen({ onDone, label = "Construindo seu Mapa da Identidade…" }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const id = setInterval(() => {
			...
			setPct(p);
			setQuoteIdx(Math.min(loadingQuotes.length - 1, Math.floor(p / 100 * loadingQuotes.length)));
			if (p >= 100) {
				clearInterval(id);
	...
	const q = loadingQuotes[quoteIdx];
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function IntroScreen({ onStart }) {
	(0, import_react.useEffect)(() => {
		fbq$2("track", "ViewContent", { content_name: "Quiz — Mapa da Identidade Homossexual" });
	}, []);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var pierry_default = "/assets/pierry-D_MOeR7m.jpg";
function fbq(...args) {
	if (typeof window !== "undefined" && window.fbq) window.fbq(...args);
}
var RAINBOW = [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
						href: "https://payfast.greenn.com.br/vqn4au9/offer/22gXH1?b_id_1=m79tysp&b_id_2=hvyb8uu&b_id_3=wsgkzrr&b_offer_3=I7WxcT&b_id_4=egs4ue5&b_offer_4=qdyuws",
						target: "_blank",
						...
						style: { background: "var(--gradient-rainbow-no-red)" },
						children: "QUERO MINHA VAGA POR R$ 19,90 →"
					})
				})
			})
		]
...
//#endregion
export { PostResultFlow as a, ResultScreen as c, flow2Questions as d, introQuestions as f, LoadingScreen as i, captureUtms as l, IntroScreen as n, QuestionScreen as o, LeadForm as r, QuizProgress as s, InsertScreen as t, flow1Questions as u };
